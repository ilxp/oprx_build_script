...
#1.88版本immortalwrt_23
#rm -rf ./package/network/utils/iptables
#rm -rf ./package/network/utils/fullconenat
#cp -rf ../immortalwrt_23/package/network/utils/iptables ./package/network/utils/iptables
#cp -rf ../immortalwrt_23/package/network/utils/fullconenat ./package/network/utils/fullconenat
...
sed -i 's,iptables-nft,iptables-legacy,g' ./package/diy/openwrt-passwall/luci-app-passwall/Makefile
sed -i 's,iptables-nft +kmod-nft-fullcone,iptables-mod-fullconenat,g' ./package/new/addition-trans-zh/Makefile

#lienol大神23.05是1.8.7需要再移动一次,1.8.8则不需要
